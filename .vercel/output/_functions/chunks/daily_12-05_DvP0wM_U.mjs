const id = "maj/daily_12-05.md";
						...
						const data = {title:"12 мая",description:"Размышления АА на сегодня - 12 мая",id:"133",moth:"maj",datePublished:new Date(1683158400000)};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-aa/src/content/diaries/maj/daily_12-05.md",
							rawData: undefined,
						};
