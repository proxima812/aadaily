const id = "sentyabr/daily_29-09.md";
						...
						const data = {title:"29 сентября",description:"Размышления АА на сегодня - 29 сентября",id:"273",moth:"sentyabr",datePublished:new Date(1683158400000)};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-aa/src/content/diaries/sentyabr/daily_29-09.md",
							rawData: undefined,
						};
