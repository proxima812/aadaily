const id = "sentyabr/daily_09-09.md";
						...
						const data = {title:"9 сентября",description:"Размышления АА на сегодня - 9 сентября",id:"253",moth:"sentyabr",datePublished:new Date(1683158400000)};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-aa/src/content/diaries/sentyabr/daily_09-09.md",
							rawData: undefined,
						};
